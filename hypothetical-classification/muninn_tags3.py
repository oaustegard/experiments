"""Muninn tags again, with the REGISTER prompt that beat novelty on WANDS (0.564 vs 0.489).
...
P="""You are writing entries for a topic-tag vocabulary used by an engineering memory store.
...
json.dump(H, open("muninn_tags3_hall.json","w"))
