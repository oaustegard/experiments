...
|---|---|---|---|---|
| [model-register-drift](model-register-drift/) | Six Claude models write the same post with no voice instruction; scored against the declauding register. Opus 5 is third-cleanest by linter and ~2x the next model once staged closers and welded epigrams are counted. |
